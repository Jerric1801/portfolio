...
"birthin": {
    ...
    "sections": {
        ...
        "2": ["link_box","🌾 Visit birthin co.","https://birthin.co/"],
        "3": ["layout_1","birthin_mockup.png"], 
    }
},
"mood": {
    "name": "mood",
...
"gis": {
    ...
    "sections": {
        ...
        "2": ["link_box","🗺️ Visit the project website","https://smt201-g2-2023.netlify.app/"],
        "3": ["layout_1","building_use.png"],
        "4": ["layout_2","comparison.png", "We used a combination of OBIA, building classification techniques, and network analysis to pinpoint most severely affected areas and quantify building damage caused by the flood." ],
    }
},
"unblock": {
    "name": "Unblock",
